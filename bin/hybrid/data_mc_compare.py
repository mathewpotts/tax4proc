...
if __name__=='__main__':
    # Define variables
    det,plot  = read_in_args()
    last_date_data,last_date_mc = find_last_date(det)
    filename1 = '/home/glados/Data_Storage_2/{0}/pass5/data/processing/root_all_files/20190625-{1}.{0}.ps5.ps2g.drmdpcgf.root'.format(det,last_date_data)
    filename2 = '/home/glados/Data_Storage_2/{0}/mc/processing/root_all_files/pr.1e17-1e21.20190625-{1}.{0}.ps5.drmdpcgf.root'.format(det,last_date_mc)
